...
<h2 className="font-serif text-gray-500 mt-14 text-2xl "   
 >Our Services</h2>
<h2 className="text-4xl w-[300px] md:w-[700px] font-sans" data-aos="fade-down"  
>Welcome to PlanMyDay Event Agency!
</h2>
...
Event managers or event planning companies offer their expertise to ensure that events run smoothly and successfully.</p>
 ...
 className="grid max-w-[1000px] mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 rounded-md mb-12 gap-4">
