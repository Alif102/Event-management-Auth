...
<h2 className="font-serif text-gray-500 mt-14 text-2xl">Contact Details</h2>
<h2 className="text-4xl w-[300px] md:w-[700px] font-sans"> If you would like to know more about my work or process feel free to get in touch
</h2>
</div>
