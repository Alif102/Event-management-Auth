  ...
  return (
    <div>
      <div className="flex text-center flex-col justify-center items-center space-y-4 ">
        ...
        <h2 className="font-serif text-gray-500 mt-14 text-xl" data-aos="fade-up">Our Shop</h2>
       
        <h2 className="text-4xl w-[300px] md:w-[700px] font-sans"data-aos="fade-up">Discover Elegant Solutions for Your Big Day</h2>
        ...
        <div className="grid md:max-w-[1000px] items-center mx-auto mt-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
